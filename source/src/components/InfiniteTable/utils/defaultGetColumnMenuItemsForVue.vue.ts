/**
 * Vue sibling of defaultGetColumnMenuItems.tsx — the default column menu
 * definition (sort/pin/filter items + the Columns / Group by submenus with
 * Vue checkboxes).
 */
import { h } from 'vue';
...
import { InfiniteCheckBox } from '../components/CheckBoxForVue.vue';
