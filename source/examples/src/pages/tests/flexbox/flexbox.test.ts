...
export default describe('flexbox', () => {});
describe('flexbox', () => {
  ...
  it('should throw on negative availableSize', () => {
    expect(() =>
      computeFlex({
        items: [],
        availableSize: -10,
  ...
  it('should throw on items with neither flex nor size', () => {
    expect(() =>
      computeFlex({
  ...
  it('should return same things when no items are flexed', () => {
    expect(
      computeFlex({
        availableSize: 100,
        items: [
  ...
  it('should work when a flex is used', () => {
    expect(
      computeFlex({
        availableSize: 100,
        items: [
  ...
  it('should work when 2+1 flex and flex available size = 7', () => {
    expect(
      computeFlex({
        availableSize: 10,
        items: [
  ...
  it('should work when 1+2 flex and flex available size = 7', () => {
    expect(
      computeFlex({
        availableSize: 10,
        items: [
  ...
  it('should work when flex available space (FAB) = 6, and flex = 1 + 2, but second flex has maxWidth = 2', () => {
    expect(
      computeFlex({
        availableSize: 8,
        items: [
  ...
  it('should work when flex available space (FAB) = 6, and flex = 1 + 2, but first flex has minSize = 4', () => {
  ...
  it('should work when flex available space (FAB) = 8, and flex = 2(max 3) + 1 + 2', () => {
    const result = computeFlex({
      availableSize: 10,
      items: [
        {
