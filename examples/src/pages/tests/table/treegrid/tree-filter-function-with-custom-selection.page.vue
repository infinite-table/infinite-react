...
import type { TreeSelectionValue } from '@infinite-table/infinite-vue';
...
const treeSelection = ref<TreeSelectionValue>({
  defaultSelection: false,
  selectedPaths: [],
});

(globalThis as any).treeSelection = treeSelection.value;

const setTreeSelection = (selection: TreeSelectionValue) => {
  treeSelection.value = selection;
  (globalThis as any).treeSelection = selection;
};

const onTreeSelectionChange = withSelectedLeafNodesOnly(setTreeSelection);
