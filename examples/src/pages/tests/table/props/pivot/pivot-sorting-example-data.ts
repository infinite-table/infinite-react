...
export const data: WebFrameworkDetailed[] = [
  ...
  },
  {
    id: 80154728,
    name: 'lit-html',
    full_name: 'lit/lit-html',
    html_url: 'https://github.com/lit/lit-html',
    description: 'An efficient, expressive, extensible HTML templating library for JavaScript.',
    created_at: 'Tue Jan 24 2017',
    updated_at: 'Mon Dec 20 2021',
    pushed_at: 'Fri Dec 17 2021',
    homepage: 'https://lit.dev',
    ...
    open_issues_count: 84,
    license: 'BSD 3-Clause',
    topics: ['html-templates', 'lit', 'lit-html', 'web-components'],
    subscribers_count: 186,
    has_projects: true,
    has_wiki: false,
    has_pages: false,
    closed_issues_count: 612,
    open_pr_count: 11,
    closed_pr_count: 804,
    week_issue_change: 2,
    stats: [14721, 721, 84, 186, 11],
  },
  {
    id: 213460191,
    name: 'htmx',
    ...
    description:
      'High power tools for HTML — access AJAX, CSS Transitions, WebSockets and Server Sent Events directly in HTML.',
    created_at: 'Wed Oct 09 2019',
    updated_at: 'Mon Dec 20 2021',
    pushed_at: 'Sun Dec 19 2021',
    homepage: 'https://htmx.org',
    stargazers_count: 8720,
    language: 'HTML',
    forks_count: 318,
    open_issues_count: 142,
    license: 'BSD 3-Clause',
    topics: ['html', 'ajax', 'hypermedia', 'htmx'],
    subscribers_count: 97,
    has_projects: false,
    has_wiki: false,
    has_pages: true,
    closed_issues_count: 890,
    open_pr_count: 28,
    closed_pr_count: 412,
    week_issue_change: 4,
    stats: [8720, 318, 142, 97, 28],
  },
  {
    id: 90000001,
    name: 'highlight.js',
    full_name: 'highlightjs/highlight.js',
    html_url: 'https://github.com/highlightjs/highlight.js',
    description: 'JavaScript syntax highlighter with language auto-detection.',
    created_at: 'Wed Jan 06 2010',
    updated_at: 'Mon Dec 20 2021',
    pushed_at: 'Sun Dec 19 2021',
    homepage: 'https://highlightjs.org',
    stargazers_count: 21480,
    language: 'JavaScript',
    forks_count: 3451,
    open_issues_count: 112,
    license: 'BSD 3-Clause',
    topics: ['syntax-highlighting', 'javascript'],
    subscribers_count: 410,
    has_projects: false,
    has_wiki: false,
    has_pages: true,
    closed_issues_count: 2100,
    open_pr_count: 19,
    closed_pr_count: 1800,
    week_issue_change: 3,
    stats: [21480, 3451, 112, 410, 19],
  },
  {
    id: 90000002,
    name: 'ionic',
    ...
    description: 'A cross-platform mobile SDK for web developers.',
    created_at: 'Thu Aug 20 2013',
    updated_at: 'Mon Dec 20 2021',
    pushed_at: 'Sun Dec 19 2021',
    ...
    license: 'Other',
    topics: ['ionic', 'mobile', 'typescript'],
    subscribers_count: 1500,
    has_projects: true,
    has_wiki: true,
    has_pages: false,
    closed_issues_count: 9800,
    open_pr_count: 40,
    closed_pr_count: 6200,
    week_issue_change: 6,
    stats: [48600, 13500, 430, 1500, 40],
  },
  {
    id: 90000003,
    name: 'lit-element',
    full_name: 'lit/lit-element',
    html_url: 'https://github.com/lit/lit-element',
    description: 'A simple base class for creating fast, lightweight web components.',
    created_at: 'Wed May 03 2017',
    updated_at: 'Mon Dec 20 2021',
    pushed_at: 'Fri Dec 17 2021',
    homepage: 'https://lit.dev',
    ...
    license: 'BSD 3-Clause',
    topics: ['web-components', 'lit', 'typescript'],
    subscribers_count: 95,
    has_projects: true,
    has_wiki: true,
    has_pages: false,
    closed_issues_count: 410,
    open_pr_count: 5,
    closed_pr_count: 390,
    week_issue_change: 1,
    stats: [4120, 380, 22, 95, 5],
  },
  {
    id: 90000004,
    ...
    description: 'A professional front-end template for building fast, robust, adaptable web apps or sites.',
    created_at: 'Sun Jan 24 2010',
    updated_at: 'Mon Dec 20 2021',
    pushed_at: 'Sun Dec 19 2021',
    homepage: 'https://html5boilerplate.com',
    stargazers_count: 54700,
    language: 'HTML',
    forks_count: 12200,
    open_issues_count: 8,
    license: 'MIT License',
    topics: ['html5', 'boilerplate', 'frontend'],
    subscribers_count: 2500,
    has_projects: false,
    has_wiki: true,
    has_pages: true,
    closed_issues_count: 1700,
    open_pr_count: 4,
    closed_pr_count: 1400,
    week_issue_change: 0,
    stats: [54700, 12200, 8, 2500, 4],
  },
  {
    id: 90000005,
    name: 'materialize',
    ...
    created_at: 'Tue Sep 08 2014',
    updated_at: 'Mon Dec 20 2021',
    pushed_at: 'Sun Dec 19 2021',
    homepage: 'https://materializecss.com',
    stargazers_count: 38800,
    language: 'HTML',
    forks_count: 4900,
    open_issues_count: 760,
    license: 'Other',
    topics: ['material-design', 'css', 'html'],
    subscribers_count: 1100,
    has_projects: false,
    has_wiki: false,
    has_pages: true,
    closed_issues_count: 5400,
    open_pr_count: 70,
    closed_pr_count: 2100,
    week_issue_change: 2,
    stats: [38800, 4900, 760, 1100, 70],
  },
  {
    id: 90000006,
    name: 'pure',
    full_name: 'pure-css/pure',
    html_url: 'https://github.com/pure-css/pure',
    description: 'A set of small, responsive CSS modules that you can use in every web project.',
    created_at: 'Wed May 01 2013',
    updated_at: 'Mon Dec 20 2021',
    pushed_at: 'Sun Dec 19 2021',
    homepage: 'https://purecss.io',
    stargazers_count: 23100,
    language: 'HTML',
    forks_count: 2450,
    open_issues_count: 18,
    license: 'BSD 3-Clause',
    topics: ['css', 'html', 'purecss'],
    subscribers_count: 620,
    has_projects: false,
    has_wiki: true,
    has_pages: true,
    closed_issues_count: 680,
    open_pr_count: 7,
    closed_pr_count: 540,
    week_issue_change: 1,
    stats: [23100, 2450, 18, 620, 7],
  },
];
