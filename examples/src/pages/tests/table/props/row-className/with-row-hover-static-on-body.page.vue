...
// the React page pushes 'hover-row' into the static
// InfiniteTable.Body.rowHoverClassName array - the Vue build has no Body
// sub-component, so the equivalent top-level prop is used
</script>
