      ...
      <div className={`${fullWidthContainer} ${minHeightFull}  `}>
        ...
        <Header
          title={
            <div className="relative">
              ...
              />
              <div
                className={`${HighlightBrandToLightBackground} px-3 relative`}
              >
                {title}
              </div>
            </div>
        ...
        >
          <Link href="/docs/latest/learn/getting-started/full-demo">
            <a
              className="cursor-pointer outline-none relative my-20"
              tabIndex={-1}
            >
              <div
          ...
          <div className="mb-10 flex justify-end w-full">
            ...
            <SecondaryButton className="ml-5">Read the docs</SecondaryButton>
          </div>
        </Header>
        <main
